...
- The `file` tables on your schema, via [`schema().files()`](/schema/defining-schema#file-tables).
...
- [Deployment](/outer/deployment) — match the storage backend to your host
- [Permissions](/outer/permissions) — the vocabulary `.files()` reuses
